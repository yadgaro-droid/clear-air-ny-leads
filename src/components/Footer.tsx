          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start text-sm text-muted-foreground">
                ...
                <span>123 Clean Air Street<br />New York, NY 10001</span>
              </li>
              <li className="flex items-center text-sm text-muted-foreground">
                <Phone className="h-5 w-5 mr-2 flex-shrink-0 text-primary" />
                <a href="tel:+15555382532" className="hover:text-primary transition-colors">(555) 538-2532</a>
              </li>
              <li className="flex items-center text-sm text-muted-foreground">
                <Mail className="h-5 w-5 mr-2 flex-shrink-0 text-primary" />
                <a href="mailto:info@nyductcleaning.com" className="hover:text-primary transition-colors">info@nyductcleaning.com</a>
              </li>
            </ul>
          </div>
        </div>
